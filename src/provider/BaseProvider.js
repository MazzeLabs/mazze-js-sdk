...
class BaseProvider extends EventEmitter {
   ...
   *
   * @example
   * > await provider.request({method: 'mazze_epochNumber'});
   * > await provider.request({method: 'mazze_getBlockByHash', params: [blockHash]});
   */
   ...
   *
   * @example
   * > await provider.call('mazze_epochNumber');
   * > await provider.call('mazze_getBlockByHash', blockHash);
   */
   ...
   *
   * @example
   * > await provider.send('mazze_epochNumber');
   * > await provider.send('mazze_getBlockByHash', [blockHash]);
   */
   ...
   *   { method: 'mazze_getBalance', params: ['mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhvey1umfzwp'] },
   *   { method: 'InValidInput' },
   * ])
