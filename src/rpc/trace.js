...
format.action = format({
  action: {
    ...
    fromPocket: format.any,
    toPocket: format.any,
    space: format.any, // From proxyProvider v2.0, create/call trace will have this field
    fromSpace: format.any, // From proxyProvider v2.0, internal_transfer_action will have this field
    toSpace: format.any, // From proxyProvider v2.0, internal_transfer_action will have this field
    value: format.bigUInt,
    gas: format.bigUInt,
    gasLeft: format.bigUInt,
    input: format.hex,
...
class Trace extends RPCMethodFactory {
  constructor(proxyProvider) {
    super(proxyProvider, Trace.methods());
