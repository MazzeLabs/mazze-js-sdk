...
test('event', () => {
  ...
  expect(coder.encodeTopics(['mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd', null]))
  ...
  expect([...coder.decodeLog(log)])
    .toEqual(['mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd', JSBI.BigInt(10)]);
});
...
test('event.anonymous', () => {
  ...
  expect([...tuple]).toEqual(['mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd', JSBI.BigInt(10)]);
  expect(tuple.toObject()).toEqual({
    account: 'mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd',
