...
test('hex40', () => {
  ...
  expect(format.address('0x1b716c51381e76900ebaa7999a488511a4e1fd0a', CONST.DEVNET_ID))
    .toEqual('mazzetest:aar1c5cvhathreas1mx3xgwjuyj4k2t7bjxacwxjhs');
  expect(format.address('0X1B716C51381E76900EBAA7999A488511A4E1FD0A', CONST.DEVNET_ID))
    .toEqual('mazzetest:aar1c5cvhathreas1mx3xgwjuyj4k2t7bjxacwxjhs');
  expect(format.address('0x1B716c51381e76900EBAA7999A488511A4E1fD0a', CONST.DEVNET_ID))
    .toEqual('mazzetest:aar1c5cvhathreas1mx3xgwjuyj4k2t7bjxacwxjhs');
...
test('address', () => {
  ...
  expect(format.address('0x0123456789012345678901234567890123456789', 1)).toEqual('mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd');
  expect(format.address('mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd')).toEqual('mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd');
  expect(format.address(Buffer.from('0123456789012345678901234567890123456789', 'hex'), 1)).toEqual('mazzetest:aaawgvnhveawgvnhveawgvnhveawgvnhveck0fj6kd');

  expect(() => format.address('0x0123456789012345678')).toThrow('not match "hex40"');
  expect(() => format.address('mazze123')).toThrow('not match "hex"');
});
